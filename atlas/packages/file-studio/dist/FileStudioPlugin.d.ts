...
export declare const FileStudioPluginCapabilities: readonly ["atlas.file-tree", "atlas.file-editor", "atlas.syntax-highlighting", "atlas.yaml-validation", "atlas.file-upload", "atlas.file-download", "atlas.scoped-filesystem"];
