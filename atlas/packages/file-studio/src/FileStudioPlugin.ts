...
export const FileStudioPluginCapabilities = [
  ...
  "atlas.file-backup",
  "atlas.file-history",
  "atlas.problem-report",
  "atlas.homeassistant-config-check",
...
export function createFileStudioPlugin(
  ...
  return {
    manifest: {
      ...
      version: "0.1.30",
      description: "Scoped file tree, editor, image preview, ZIP inspection, backup and diagnostics plugin for Home Assistant configuration files.",
      descriptionI18n: {
        de: "Abgesichertes Dateibaum-, Editor-, Bildvorschau-, ZIP-, Backup- und Diagnose-Plugin für Home-Assistant-Konfigurationsdateien.",
        en: "Scoped file tree, editor, image preview, ZIP inspection, backup and diagnostics plugin for Home Assistant configuration files.",
      },
      icon: "icon.svg",
      preview: "preview.svg",
      extensionPoints: Object.values(FileStudioExtensionPoints),
...
export function createFileStudioPluginInstallPackage(): RuntimePluginInstallPackage {
  ...
  return createRuntimePluginInstallPackage({
    ...
    readme: [
      ...
      "surface, image previews, ZIP inspection, syntax highlighting, YAML validation, upload/download flows, backups and diagnostics.",
      "",
