...
export function createFileStudioPlugin(
  ...
  return {
    manifest: {
      ...
      version: "0.1.19",
      description: "Scoped file tree, editor and image preview plugin for Home Assistant configuration files.",
      descriptionI18n: {
        de: "Abgesichertes Dateibaum-, Editor- und Bildvorschau-Plugin für Home-Assistant-Konfigurationsdateien.",
        en: "Scoped file tree, editor and image preview plugin for Home Assistant configuration files.",
      },
      icon: "icon.svg",
      preview: "preview.svg",
      extensionPoints: Object.values(FileStudioExtensionPoints),
...
export function createFileStudioPluginInstallPackage(): RuntimePluginInstallPackage {
  ...
  return createRuntimePluginInstallPackage({
    ...
    readme: [
      ...
      "surface, image previews, syntax highlighting, YAML validation and upload/download flows.",
      "",
