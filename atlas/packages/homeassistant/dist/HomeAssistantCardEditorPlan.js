...
export function listHomeAssistantCardEditorTemplates() {
    return cardEditorTemplates;
}
export function findHomeAssistantCardEditorTemplate(templateId) {
    return cardEditorTemplates.find(template => template.id === templateId);
}
export function createHomeAssistantCardEditorFieldFromTemplate(input) {
...
export function createHomeAssistantCardEditorPackagePlan(input = {}) {
...
export function createHomeAssistantCardEditorDependencyPlan(input = {}) {
...
export function createHomeAssistantCardEditorScriptExport(input = {}) {
    ...
    const cardType = `custom:${customElementName}`;
    const defaultConfig = {
        type: cardType,
...
export function analyzeHomeAssistantCardEditorSurface(fields = []) {
...
export function arrangeHomeAssistantCardEditorSurfaceFields(fields = [], bounds = defaultGridBounds) {
    const placedFields = [];
...
export function createHomeAssistantCardEditorConfiguration(input = {}) {
    const editorPlan = createHomeAssistantCardEditorPackagePlan(input);
    ...
    const fieldCards = [...editorPlan.fields]
        ...
        .filter((fieldCard) => fieldCard.card !== undefined)
...
export function normalizeHomeAssistantCardEditorScriptFilename(name) {
...
export function normalizeHomeAssistantCustomElementName(scriptFilename) {
...
export function clampSurfaceFieldPlacement(placement, bounds = defaultGridBounds) {
...
function dedupeLayouts(values) {
    return [...new Set(values)];
}
function dedupeCardTargets(values) {
    return [...new Set(values)];
}
function dedupeSurfaceFieldLayouts(values) {
    return [...new Set(values)];
}
function normalizeSurfaceField(field) {
    return {
        ...
        ...((field.target === "tabbed-card-v2" || field.layout === "horizontal-stack" || field.layout === "vertical-stack") && field.columns === "full" ? { columns: "full" } : {}),
        ...
        ...((field.target === "tabbed-card-v2" || field.layout === "horizontal-stack" || field.layout === "vertical-stack") && field.rows === "auto" ? { rows: "auto" } : {}),
...
function compareSurfaceFields(first, second) {
...
function hasSurfaceFieldContent(field) {
    if (field.entityId)
        return true;
    if (field.target === "link" || field.target === "webpage")
        return true;
...
function listSurfaceFieldOverlaps(fields) {
    const overlaps = [];
...
function isSurfaceContainerField(field) {
    return field.target === "tabbed-card-v2"
        || field.layout === "horizontal-stack"
        || field.layout === "vertical-stack";
}
function findFirstAvailableSurfacePlacement(field, placedFields, bounds) {
...
function surfaceFieldsOverlap(first, second) {
...
function createSurfaceFieldCardConfiguration(field) {
...
function createSurfaceFieldEntryCardConfiguration(entry) {
...
function normalizeTabIndex(value, tabCount) {
...
function defaultEntityForTarget(target) {
    if (target === "webpage")
...
function createHomeAssistantCardEditorScriptSource(customElementName, defaultConfig) {
...
function groupSurfaceFieldCardsByRow(fieldCards) {
    const rows = new Map();
