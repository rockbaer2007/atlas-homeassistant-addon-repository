...
export const HomeAssistantCardEditorPluginServiceKey = Symbol("@atlas/homeassistant/card-editor-plugin");
export function createHomeAssistantCardEditorPluginService() {
    return {
...
export function createHomeAssistantCardEditorPlugin() {
    return {
        manifest: {
...
export function createHomeAssistantCardEditorPluginInstallPackage() {
